# Generated by Django 3.2 on 2022-12-17 21:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Administrator'), ('moderator', 'Moderator'), ('user', 'User')], default='user', max_length=50, verbose_name='Уровень доступа')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(default='-', on_delete=django.db.models.deletion.SET_DEFAULT, related_name='titles', to='reviews.category', verbose_name='категория')),
                ('genre', models.ManyToManyField(default='-', related_name='titles', to='reviews.Genre', verbose_name='категория')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
                ...
                ('title', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='title', to='reviews.title', verbose_name='Заголовок отзыва')),
            ],
        ),
        migrations.CreateModel(
            name='GenreTitle',
